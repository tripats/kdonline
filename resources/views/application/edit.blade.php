                      ...
                      <!-- wenn nicht komposition duration einblenden -->
                        @if ($application->activity_id != 5)
                          ...
                          <div class="form-group has-feedback {{ $errors->has('duration') ? ' has-error ' : '' }}">
                            ...
                            <div class="col-sm-6">
                              {!! Form::select('duration', $options, $application->duration, ['class' => 'form-control', 'required' => 'required', 'single']) !!}
                        ...
                        @endif
                          ...
                          <div class="form-group has-feedback {{ $errors->has('is_painting') ? ' has-error ' : '' }}">
                            ...
                            <div class="col-sm-6">
                                {!! Form::checkbox('is_painting', 1, null, ['id' => 'is_family']) !!} {{ __('application.is_painting')}}
                          ...
                          {{Form::hidden('is_participative',0)}}
                        ...
                        <!--  wenn kww -->
                            ...
                            {{Form::hidden('is_focus_visual',0)}}
                          <div class="form-group has-feedback {{ $errors->has('is_focus_visual') ? ' has-error ' : '' }}">
                            <div class="col-sm-4 control-label"></div>
                            <div class="col-sm-6">
                                {!! Form::checkbox('is_focus_visual', 1, null, ['id' => 'is_focus_visual']) !!} {{ __('application.is_focus_visual')}}
                            ...
                            {{Form::hidden('is_focus_sciences',0)}}
                          <div class="form-group has-feedback {{ $errors->has('is_focus_sciences') ? ' has-error ' : '' }}">
                            ...
                            {{Form::hidden('is_focus_economics',0)}}
                        ...
                        @if ($application->activity_id == 4)
                          ...
                          <div class="form-group has-feedback {{ $errors->has('is_theather') ? ' has-error ' : '' }}">
                            ...
                            {{Form::hidden('is_literature_both',0)}}
