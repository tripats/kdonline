						...
						<div class="tab-content">
							<span class="tab-pane active edit_profile">
								...
								@if (empty($user->name) || empty($user->first_name) || empty($user->last_name)  )
									@if ( App::getLocale() == 'en')
										<font color="#ff0000">Please fill in your (user/first and last-)name as well (click on the 3 dots on the right, to find under account settings)</font>
									@elseif ( App::getLocale() == 'de' )
										<font color="#ff0000">Bitte auch Ihren Benutzer, Vor- und Zunamen ausfüllen (rechts auf die 3 Punkte klicken, zu finden unter Kontoeinstellungen)</font>
									@endif
								@endif
							</span>
